...
#define AUTHORS {"Kyle R. Burton", "Jonas Frantz", "Alexey Loginov", "Piotr Najman", "Arno W. Peters", "Georges Khaznadar", "Mauricio Rivera", "Lalo Martins", "Sven Neumann", "Christian Klein", "Koen Kooi", "Ambrogio Oliva", "Felix Natter", "Michael Shigorin", "Costantino Ceoldo", "Arkadiusz Lipiec", "Sebastien Bacher", "Daniel Leidert", "Theppitak Karoonboonyanan", "Zach Ploskey", "Jon Abbott", "Andrew Dalke", "Gunner Poulsen", "Gonzalo Regueiro Iglesias", "Leandro Regueiro", "Andrea Tasso", "Osman Köşeli", "Frederic Gobry", "Ireneusz Imiolek", "Oleksandr Mishchenko", "Juan Rafael Fernández", "Fırat Kutlu", "Pavel Fric", "Yves Brungard", "Marcio Padula", "Uladyslau Ahromenka", "Rémi Verschelde", NULL}
